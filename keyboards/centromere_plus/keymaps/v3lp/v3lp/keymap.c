...
[_QWERTY] = { /*QWERTY*/
	...
	{KC_TAB,    KC_Q,      KC_W,     KC_E,    KC_R,    KC_T,      KC_PGUP,    KC_LBRC,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,       KC_DEL },
	{KC_LSFT,    KC_A,      KC_S,    KC_D,    KC_F,   KC_G,        KC_INS,    KC_RBRC,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,   KC_QUOT },
	{KC_LCTL,   KC_Z,      KC_X,     KC_C,    KC_V,    KC_B,      XXXXXXX,    XXXXXXX,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,    KC_ENT },
	{KC_END,   KC_PGDN,   KC_HOME, KC_DEL,  KC_LALT,  LOWER,    KC_SPC,      KC_SPC,   RAISE,  KC_LGUI,   KC_DOWN,   KC_RIGHT,    KC_UP,  KC_LEFT}
